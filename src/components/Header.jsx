    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 2xl:h-20 gap-4">
            ...
            >
              ...
              <span className="font-display text-xs sm:text-sm 2xl:text-base font-semibold tracking-[0.15em] sm:tracking-widest gold-text uppercase whitespace-nowrap">
                TimeTravel Agency
              </span>
            </button>

            {/* Desktop Nav — visible seulement à partir de lg (1024px) */}
            <nav className="hidden 2xl:flex items-center justify-center gap-8 whitespace-nowrap flex-1" aria-label="Navigation principale">
              {navLinks.map((link) => (
                <button
                  key={link.href}
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              ...
              <button
                ...
                className="hidden 2xl:block btn-gold px-5 py-2 rounded-full text-xs tracking-widest uppercase whitespace-nowrap flex-shrink-0"
              >
              ...
              <button
                ...
                className="2xl:hidden flex flex-col justify-center items-center w-9 h-9 rounded-lg border border-[#1e2a3a]/60 hover:border-[#c9a84c]/40 transition-colors duration-200"
        ...
        {menuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-0 top-16 z-40 2xl:hidden"
              style={{
